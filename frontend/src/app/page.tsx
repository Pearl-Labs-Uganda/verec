      ...
      try {
        ...
        if (data.detection) {
          ...
          const objs = d.objects
            .map((o: DetectionObject) => o.class)
            .join(", ");
          setDetectionInfo(
            `${d.count} objects | ${d.time_ms}ms | ${d.fps} FPS — ${objs || "none"}`,
          );
          setLog((prev) => {
    ...
    <div className="min-h-screen bg-stone-950 text-stone-100">
      ...
      <header className="border-b border-stone-800 px-6 py-4">
        ...
        <p className="text-sm text-stone-400">
          Video Recognition &amp; Reporting — real-time object detection,
          segmentation, VLM captioning &amp; LLM reports
        </p>
      </header>
      ...
      <main className="px-6 pb-8">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-[2] space-y-3">
                ...
                <details open className="bg-stone-900 rounded p-3">
                  <summary className="text-sm font-semibold text-stone-300 cursor-pointer">
                    Source
                  </summary>
                    ...
                    <div className="flex gap-3 text-xs">
                      ...
                      <label className="flex items-center gap-1">
                        <input
                          type="checkbox"
                          checked={enableSeg}
                          onChange={(e) => setEnableSeg(e.target.checked)}
                          className="accent-orange-500"
                        />
                        Segmentation
                      </label>
                ...
                <div className="bg-stone-900 rounded p-3">
                  <h4 className="text-xs font-semibold text-stone-400 mb-1">
                    Scene Caption (VLM)
                  </h4>
                  <p className="text-sm text-stone-200 min-h-[2em]">
                    {caption || "—"}
                  </p>
                </div>
              </div>
        ...
        {tab === "export" && (
          <div className="bg-stone-800 rounded-b rounded-tr p-6 space-y-4">
            ...
            <p className="text-sm text-stone-400">
              Export all collected detection, VLM caption, and report data as
              JSON.
            </p>
            <button
